...
class Appointment extends Component {
  ...
  addMessage(e){
    ...
    fire.database().ref('limpiezas').push( this.inputS1.checked);
    fire.database().ref('extracciones').push( this.inputS2.checked);
    fire.database().ref('rellenos').push( this.inputS3.checked);
    fire.database().ref('cambiosligas').push( this.inputS4.checked);
                      ...
                      <form onSubmit={this.addMessage.bind(this)}>
                        ...
                        <div className="title">
                            <h1>Cita</h1>
                              ...
                              <div className="">
                                    <label className="" htmlFor="phone">Telefono</label>
                              ...
                              <div className="">
                                    <label className="" htmlFor="date">Elija Fecha</label>
                              ...
                              <div>
                                    <label className="" htmlFor="time">ELija Hora</label>
                            ...
                            <div >
                              ...
                              <div>
                                ...
                                <label className="container4" >Limpieza dental
                                  <input type="checkbox" ref={ el => this.inputS1 = el }></input>
                                  <span className="checkmark"></span>
                                </label>

                                <label name="cb1" className="container4">Extraccion diente
                                  <input  type="checkbox" ref={ el => this.inputS2 = el }></input>
                                  <span className="checkmark"></span>
                                </label>

                                <label name="cb2" className="container4">Relleno caries
                                  <input type="checkbox" ref={ el => this.inputS3 = el }></input>
                                  <span className="checkmark"></span>
                                </label>

                                <label name="cb3" className="container4">Cambio de liga
                            ...
                            <div className="container3">
                                  <button type="submit" id="" name="" onClick={this.showNotifications} className="">Confirmar</button>
                            </div>
